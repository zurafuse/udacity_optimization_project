...
var resizePizzas = function(size) {
  ...
  The new width, determined by the size variable being passed to the function, determines
  the new pizza sizes. I don't even need to know what the previous size was.
  */
...
function updatePositions() {
  ...
  //Move the body.scrollTop calculation outside of the for loop. Otherwise,
  //the body will be read every time in the loop, forcing a repeating Layout.
...
//I changed the number of pizzas being created by the loop from 200 to 60.
//200 pizzas don't fit on the page anyway, so I feel like it was a waste of resources.
